  ...
  while(have_posts()) { 
    ...
    <div class="container container--narrow page-section">
      ...
      <?php if($parent_page_id): ?>
        ...
        <div class="metabox metabox--position-up metabox--with-home-link">
          <p>
            ...
            href="<?php echo get_permalink($parent_page_id) ?>"
            >
              <i class="fa fa-home" aria-hidden="true"></i> Back to <?php echo get_the_title($parent_page_id) ?> 
            </a> 
      ...
      <?php 
        ...
        $children = get_page_children($current_page_id, $arguments);
